...
function getTipContent (props) {
  if (props.multiline) return "This is a long tip to illustrate how the `multiline` option works."
...
class Tip extends React.Component {
  render () {
    ...
    if (!anchor && !position && !multiline) return <span data-has-tip data-tip-content="This is a tip"> Hover me for a tip </span>
    return <span data-has-tip={applyTipOptions(this.props)} data-tip-content={getTipContent(this.props)}> Hover me for a tip </span>
  }
}
