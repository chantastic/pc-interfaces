...
(function() {
  ...
  function applyButtonClasses(props) {
    return ["btn", props.purpose, props.size, props.outline && "btn--outline"]
      .filter(e => e)
      .join(" ");
  }
          ...
          <div className="d-f f_1 pb-1">
              ...
              <form onChange={handlePurposeChange.bind(this)}>
                ...
                <label>
                  <input
                    type="radio"
                    value="btn--primary"
                    checked={this.state.purpose === "btn--primary"}
                    readOnly
                  />
                ...
                <label>
                  <input
                    type="radio"
                    value="btn--success"
                    checked={this.state.purpose === "btn--success"}
                    readOnly
                  />
                ...
                <label>
                  <input
                    type="radio"
                    value="btn--warning"
                    checked={this.state.purpose === "btn--warning"}
                    readOnly
                  />
              ...
              <form onChange={handleSizeChange.bind(this)}>
                ...
                <label>
                  <input
                    type="radio"
                    value="btn--large"
                    checked={this.state.size === "btn--large"}
                    readOnly
                  />
                  <code>.btn--large</code>
                </label>
                <label>
                  <input
                    type="radio"
                    value="btn--small"
                    checked={this.state.size === "btn--small"}
                    readOnly
                  />
                  <code>.btn--small</code>
                </label>
                ...
                <label>
                  <input
                    type="radio"
                    value="btn--micro"
                    checked={this.state.size === "btn--micro"}
                    readOnly
                  />
                  <code>.btn--micro</code>
                </label>
            ...
            <div>
              ...
              <form onChange={handleOutlineChange.bind(this)}>
                <label>
                  <input type="checkbox" checked={this.state.outline} />
                  <code>.button--outline</code>
                </label>
              </form>
              <form onChange={handleDisabledChange.bind(this)}>
                <label>
                  <input type="checkbox" checked={this.state.disabled} />
                  <code>[disabled]</code>
                </label>
              </form>
            </div>
