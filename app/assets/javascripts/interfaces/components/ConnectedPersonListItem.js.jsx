...
(function(global) {
    ...
    render() {
      return (
        ...
        >
          <a
            href={this.link}
            style={_.extend(this.anchorStyles, this.props.anchorStyle)}
          >
  ...
  global.ConnectedPersonListItem = ((global.module || {
  }).exports = ConnectedPersonListItem);
})(this);
